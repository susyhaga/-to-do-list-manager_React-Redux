...
export const initialState: TarefasState = {
  itens:
    tarefasDoLocalStorage.length > 0
      ? tarefasDoLocalStorage
      : [
          {
            id: 1,
          ...
          },
          {
            ...
            status: enums.Status.PENDENTE, //prioridade
            descricao:
              ' Ir ao show do Descendents Dezembro no Carioca Club - SP',
            concluida: false
          },
          {
            id: 7,
          ...
          },
          {
            ...
            status: enums.Status.PENDENTE, //prioridade
            descricao:
              'Lembrar de comprar presente para o aniversário do Italo (12/08/89)',
            concluida: false
          },
          {
            id: 10,
            ...
            status: enums.Status.PENDENTE, //prioridade
            descricao:
              'Assitir ao filme "O pior vizinho do mundo" com Tom Hanks',
            concluida: true
          }
        ]
}

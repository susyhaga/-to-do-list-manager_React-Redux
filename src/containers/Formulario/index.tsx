...
const Formulario = () => {
  ...
  const cadastrarTarefa = (e: FormEvent) => { //FormEvent
    e.preventDefault()
      ...
      <Form onSubmit={cadastrarTarefa}>
        ...
        <Opcoes> {/*  estilo da label */}
          ...
          {Object.values(enums.Prioridade).map(prioridade => (
            <Opcao key={prioridade}>  {/* componente estilizado em styles*/}
              < input value={prioridade} //state
                name="prioridade"
                type="radio"
                onChange={e => setPrioridade(e.target.value as enums.Prioridade)} //evento modificador
                id={prioridade}
...
export default Formulario //exportar para pages/Cadastro
